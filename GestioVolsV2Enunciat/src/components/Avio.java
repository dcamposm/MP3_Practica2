...
public class Avio implements Component {
    ...
    public void modificarComponent() {
        ...
        fabricant = (String)demanarDades("Quin és el nou fabricant de l'avió?",4);
        System.out.println("\nEl model de l'avió és: "+model);
        model = (String)demanarDades("Quin és el nou model de l'avió?",4);
        System.out.println("\nLa capacitat de l'avió és: "+capacitat);
        capacitat = (int)demanarDades("Quina és la nova capacitat de l'avió?",1);
    }
