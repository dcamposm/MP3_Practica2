...
public class RutaIntercontinental extends RutaInternacional{
    ...
    public void modificarComponent() {
        ...
        continentOri = (String)demanarDades("Quin és el nou continent d'origen de la ruta intercontinental?",4);
        System.out.println("\nEl continent de destí de la ruta intercontinental és:"+continentDes);
        continentDes = (String)demanarDades("Quin és el nou continent de destí de la ruta intercontinental?",4);
    }
