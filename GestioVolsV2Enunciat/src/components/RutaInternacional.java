...
public class RutaInternacional extends Ruta{
    ...
    public void modificarComponent() {
        ...
        paisOri = (String)demanarDades("Quin és el nou país d'origen de la ruta internacional: ",4);
        System.out.println("\nEl país de destí de la ruta internacional és:" + paisDes);
        paisDes = (String)demanarDades("Quin és el nou país de destí de la ruta internacional? ",4);
    }
